...
contract wrapTicketModel {
    ...
    function isValid(TicketModel.TicketItem memory ticket) public pure {
        ticket.isValid();
    }
}
...
contract wrapTicketModelStorage {
    ...
    function set(uint32 id, TicketModel.TicketItem calldata ticket) public {
        data.set(id, ticket);
    }
    ...
    function get(uint32 id) public view returns (TicketModel.TicketItem memory ticket) {
        ticket = data.get(id);
    }
}
